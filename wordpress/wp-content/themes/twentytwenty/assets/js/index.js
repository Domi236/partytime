...
twentytwenty.coverModals = {
	...
	outsideUntoggle: function() {
		document.addEventListener( 'click', function( event ) {
			...
			let modal = document.querySelector( '.cover-modal.active' );
	...
	hideAndShowModals: function() {
		...
		function htmlStyles() {
			let overflow = _win.innerHeight > _doc.documentElement.getBoundingClientRect().height;
		...
		modals.forEach( function( modal ) {
			...
			modal.addEventListener( 'toggle-target-after-inactive', function( event ) {
				...
				setTimeout( function() {
					let clickedEl = twentytwenty.toggles.clickedEl;
...
twentytwenty.modalMenu = {
	...
	expandLevel: function() {
		let modalMenus = document.querySelectorAll( '.modal-menu' );

		modalMenus.forEach( function( modalMenu ) {
			let activeMenuItem = modalMenu.querySelector( '.current-menu-item' );

			if ( activeMenuItem ) {
				twentytwentyFindParents( activeMenuItem, 'li' ).forEach( function( element ) {
					let subMenuToggle = element.querySelector( '.sub-menu-toggle' );
					if ( subMenuToggle ) {
	...
	keepFocusInModal: function() {
		...
		_doc.addEventListener( 'keydown', function( event ) {
			let toggleTarget, modal, selectors, elements, menuType, bottomMenu, activeEl, lastEl, firstEl, tabKey, shiftKey,
...
twentytwenty.toggles = {
	...
	performToggle: function( element, instantly ) {
		let target, timeOutTime, classToToggle,
			self = this,
			_doc = document,
			// Get our targets
			toggle = element,
		...
		if ( document.querySelectorAll( '*[data-untoggle-above], *[data-untoggle-below], *[data-toggle-above], *[data-toggle-below]' ).length ) {
			window.addEventListener( 'resize', function() {
				...
				toggles.forEach( function( toggle ) {
					let unToggleAbove = toggle.dataset.untoggleAbove,
...
function twentytwentyMenuToggle( target, duration ) {
	let initialParentHeight, finalParentHeight, menu, menuItems, transitionListener,
		initialPositions = [],
		finalPositions = [];
